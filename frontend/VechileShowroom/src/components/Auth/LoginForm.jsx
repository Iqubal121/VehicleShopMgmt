    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            if (isLogin) {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        navigate('/');
                        setErrorMessage(result.message || 'Login successfull!');
                    } else {
                ...
                if (password === confirmPassword) {
                    ...
                    setConfirmPassword('');
                    setName('');
                    setMessageAfterSignUp('Please Sign using recently registered credentials!!')
            ...
            if (isLogin) {
                ...
                setMessage('Login failed: Please correct the errors below');
            } else {
                console.log('Sign Up failed: Validation errors');
            }
